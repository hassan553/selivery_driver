...
class TripDetailsWithoutDestination extends StatefulWidget {
  final String image;
  final String name;
  final String id;
  final String status;
  ...
  // final double des1;
  // final double des2;
  const TripDetailsWithoutDestination({super.key, required this.image,
  ...
  @override
  State<TripDetailsWithoutDestination> createState() => _TripDetailsState();
}

class _TripDetailsState extends State<TripDetailsWithoutDestination> {
  Position? position;
  ...
  getCurrentLocation() async {
    ...
    addMarkers(LatLng(widget.pick1, widget.pick2));
    setState(() {
